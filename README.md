# ColabのR/Pythonで回帰分析（作成中）
ここでは例年、駒澤大学経済学部で開講している「経済統計a/b履修生向け」にColab（Google Colaboratory）を使ってR/Pythonで回帰分析するやり方を解説しています（が、一般的な情報なので、インターネット上でも公開します）。

注意1：授業の「補助教材」ですので、R/Pythonの包括的な入門ではありません。ご注意ください。
<br>
